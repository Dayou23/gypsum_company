...
const Hero = () => {
  ...
  return (
    <section className="relative bg-[url(https://res.cloudinary.com/dhiwfjb94/image/upload/v1706541138/353838416_195678626773891_4152619273127480389_n_cd5626c920.jpg)] bg-cover bg-center bg-no-repeat">
